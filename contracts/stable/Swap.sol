...
contract Swap is OwnerPausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        __Swap_init(_pooledTokens, decimals, lpTokenName, lpTokenSymbol, _a, _fee, _adminFee, lpTokenTargetAddress);
    }
    ...
    /**
     * @notice Return count of the pooled token.
     * @return count of the the pooled token
     */
